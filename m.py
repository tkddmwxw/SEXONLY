...
bot = telebot.TeleBot('7158155349:AAFIQqgQz5bDce_mlGVOuRUyV9mzvMp9Zew')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "https://t.me/FEEDBACKDDOS247-You have not purchased yet purchase now from:- @RitikXyz099."
...
def clear_users_command(message):
    ...
    if user_id in admin_id:
        ...
        response = " Pani Kam Hai matke Mein Teri Man Chod Dunga Main Ek jhatake mein only free member:- @RitikXyz099 🙇."
    bot.reply_to(message, response)
...
def show_recent_logs(message):
    ...
    if user_id in admin_id:
        ...
        response = " Pani Kam Hai matke Mein free wale Tumhari man Chod Dunga Main Ek jhatake mein:- @RitikXyz099 ❄."
        bot.reply_to(message, response)
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("https://t.me/FEEDBACKDDOS247 🚫 tere baap ko bol vah approved kare dega! 🚫\n\n:- @RitikXyz099")
...
Buy From :- https://t.me/FEEDBACKDDOS247
